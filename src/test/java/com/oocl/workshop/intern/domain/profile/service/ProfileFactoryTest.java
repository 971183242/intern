...
class ProfileFactoryTest {
    ...
    void getUser() {
        ...
        assertEquals(internPo0.getInternPeriod().getDateFrom(), intern0.getPeriod().getDateFrom());
        assertEquals(internPo0.getInternPeriod().getDateTo(), intern0.getPeriod().getDateTo());
        ...
        assertEquals(internPo1.getInternPeriod().getDateFrom(), intern1.getPeriod().getDateFrom());
        assertEquals(internPo1.getInternPeriod().getDateTo(), intern1.getPeriod().getDateTo());
