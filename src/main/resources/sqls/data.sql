...
-- teams
insert into T_TEAM(team_id,name, team_leader_id) values('TMS', 'tms', null);
...
-- TeamLeader
insert into t_user(domain_id,name,email,user_type,role,date_from, date_to,team_id)
values('DONGJA3','JACKIE DONG','jackie.dong@oocl.com','EMPLOYEE','ROLE_TEAM_LEADER',null,null,'FW');
insert into t_user(domain_id,name,email,user_type,role,date_from, date_to,team_id)
values('CUIST','STIKE CUI','stike.cui@oocl.com','EMPLOYEE','ROLE_TEAM_LEADER',null,null,'WMS');
insert into t_user(domain_id,name,email,user_type,role,date_from, date_to,team_id)
values('GUDA','DAVE GU','dave.gu@oocl.com','EMPLOYEE','ROLE_TEAM_LEADER',null,null,'TMS');
